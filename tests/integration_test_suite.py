...
from scripts.starlight_extractor import extract_alpha, extract_palette, extract_lsb, extract_exif, extract_eoi
...
class TestIntegrationSuite:
    ...
    def test_clean_images_detection(self, scanner, temp_dirs):
        ...
        assert stego_count / len(results) < 0.05, f"Too many false positives: {stego_count}/{len(results)}"
