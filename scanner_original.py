...
def get_ensemble_instance():
    """Get or create cached ensemble instance (singleton pattern)"""
...
class StegoScanner:
    ...
    def scan_file(self, img_path, extract_messages=True):
        ...
        if extract_messages and detection['is_stego']:
            ...
            result['extracted_message'] = message or {}
    ...
    def scan_directory(self, directory, extract_messages=True, recursive=True,
        ...
        batch_size = 32
        for i in tqdm(range(0, len(image_files), batch_size), desc="Scanning images"):
...
def main():
    ...
    parser.add_argument('--quick', action='store_true',
                       help='Quick scan: skip extraction, only detection')
