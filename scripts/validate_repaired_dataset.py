...
class RepairedDatasetValidator:
    ...
    def _is_image(self, path: Path) -> bool:
        ...
        return path.suffix.lower() in {'.png', '.jpg', '.jpeg', '.gif', '.bmp', '.tiff', '.webp'}
    ...
    def _check_extraction_verified(self) -> bool:
        ...
        try:
            ...
            if 'extraction_verified' in manifest:
                ...
                self.warnings.append("Manifest does not contain extraction verification")
...
def main():
    parser = argparse.ArgumentParser(
        description='Validate repaired dataset quality'
    )
    parser.add_argument(
        '--dataset',
        required=True,
        help='Path to repaired dataset directory'
    )
    parser.add_argument(
        '--output',
