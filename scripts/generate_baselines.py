...
def main():
    parser = argparse.ArgumentParser(
        description="Generate baseline predictions and metrics"
    )
    parser.add_argument(
        "--submission",
        required=True,
        help="Path to submission directory (e.g., datasets/grok_submission_2025)",
    )
    parser.add_argument("--test-dataset", default="val", help="Path to test dataset")
    parser.add_argument(
        "--output-dir", default="results/baselines", help="Output directory"
    )
